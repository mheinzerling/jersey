...
class WebComponentTest {
    ...
    void test() throws ServletException, IOException {
        ...
        final Throwable throwable = Assertions.assertThrows(IOException.class, () -> WebComponent.setEntityStream(requestContext, servletRequest));
        assertEquals("catch me", throwable.getMessage());
    }
